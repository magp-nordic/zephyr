...
#define _NRFX_GRTC_NUM_OF_OWNED_CHANNELS DT_PROP_LEN(DT_INST(0, nordic_nrf_grtc), owned_channels)
#define _NRFX_GRTC_SHIFT_OWNED(val, _)                                                             \
	(1 << (DT_PROP_BY_IDX(DT_INST(0, nordic_nrf_grtc), owned_channels, val)))
...
#define _NRFX_GRTC_SHIFT_FORBIDDEN(val, _)                                                         \
	(1 << (DT_PROP_BY_IDX(DT_INST(0, nordic_nrf_grtc), child_owned_channels, val)))
#define _NRFX_GRTC_NUM_OF_FORBIDDEN_CHANNELS                                                       \
	DT_PROP_LEN(DT_INST(0, nordic_nrf_grtc), child_owned_channels)
